...
export default function VocabularyPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col max-w-lg mx-auto relative" style={{ background: "#f0f4f8" }}>
      <ChatBackground variant="green" />

      <div className="relative z-10 flex flex-col flex-1 min-h-0">
        <div className="bg-white/90 border-b border-slate-100 px-4 py-3 flex items-center gap-3 shadow-sm shrink-0" style={{ backdropFilter: "blur(12px)" }}>
          <button
        ...
        <div className="bg-white/90 border-t border-slate-100 px-3 py-3 shrink-0 shadow-lg" style={{ backdropFilter: "blur(12px)" }}>
