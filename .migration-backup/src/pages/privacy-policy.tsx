        ...
        <div className="bg-white rounded-2xl border border-border shadow-sm p-5 space-y-5 text-sm text-foreground leading-relaxed">
          ...
          <Section title="4. Third-Party Services">
            ...
            <ul className="list-disc pl-5 space-y-1 text-muted-foreground">
              ...
              <li><strong className="text-foreground">DeepSeek / OpenAI-compatible AI</strong> — your chat messages are sent to an AI provider to generate responses. These providers have their own data processing terms.</li>
            </ul>
          </Section>
          ...
          <Section title="6. Children's Privacy">
            <p className="text-muted-foreground">
              ZX-Chat AI is intended for users aged 13 and above. We do not knowingly collect personal information from children under 13. If you believe a child under 13 has provided us with personal data, please contact us immediately.
            </p>
          </Section>
