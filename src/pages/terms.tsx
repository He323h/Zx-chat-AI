        ...
        <div className="bg-white rounded-2xl border border-border shadow-sm p-5 space-y-5 text-sm text-foreground leading-relaxed">
          <div>
            ...
            <p className="text-muted-foreground text-xs">
              By using ZX-Chat AI ("the app"), you agree to these Terms of Service. Please read them carefully.
            </p>
          </div>
          ...
          <Section title="2. Description of Service">
            <p className="text-muted-foreground">
              ZX-Chat AI provides an AI-powered English language learning experience, including topic-based AI chat tutoring, voice practice, vocabulary building, and anonymous partner matching for conversation practice.
            </p>
          </Section>
          ...
          <Section title="4. AI Responses — No Guarantee of Accuracy">
            <p className="text-muted-foreground">
              AI-generated responses are for educational and practice purposes only. ZX-Chat AI does not guarantee the accuracy, completeness, or correctness of any AI-generated content. You should not rely solely on the app for formal language certification or professional communication.
            </p>
          </Section>

          <Section title="5. Subscription & Payments">
            <p className="text-muted-foreground">
              ZX-Chat AI currently offers a free 3-day trial with full access. Paid subscription plans (Basic, Pro) are <strong className="text-foreground">coming soon</strong>. When paid plans launch:
            </p>
          ...
          <Section title="7. Limitation of Liability">
            <p className="text-muted-foreground">
              ZX-Chat AI is provided "as is" without warranties of any kind. We are not liable for any indirect, incidental, or consequential damages arising from your use of the app, including but not limited to loss of data or service interruptions.
            </p>
          </Section>

          <Section title="8. Age Requirement">
            <p className="text-muted-foreground">
              You must be at least 13 years old to use ZX-Chat AI. Users under 18 should have parental or guardian consent.
            </p>
          </Section>
          ...
          <Section title="10. Contact">
            <p className="text-muted-foreground">
              ...
              <span className="font-medium text-foreground">hemantkulhada44@gmail.com</span>
            </p>
          </Section>
        </div>
      </div>
