    ...
    <div className="min-h-screen" style={{ background: "#f0f4f8" }}>
      ...
      <div className="max-w-lg mx-auto px-4 py-6 space-y-4">
        ...
        <div className="bg-white rounded-2xl border border-border shadow-sm p-6 flex flex-col items-center text-center fade-up">
          <div className="w-20 h-20 rounded-3xl flex items-center justify-center shadow-lg mb-4"
            style={{ background: "hsl(var(--primary))" }}>
            <span className="text-3xl text-white font-bold">ZX</span>
          </div>
          <h2 className="text-xl font-bold text-foreground">ZX-Chat AI</h2>
          <p className="text-xs text-muted-foreground mt-1">Version {APP_VERSION}</p>
          <p className="text-sm text-muted-foreground mt-3 max-w-xs leading-relaxed">
            ZX-Chat AI is an AI-powered English language learning app designed to help you practise speaking, listening, and writing English through real conversations.
          </p>
        </div>

        {/* Features */}
        <div className="bg-white rounded-2xl border border-border shadow-sm p-5 fade-up">
          <p className="text-xs font-semibold uppercase tracking-wide text-muted-foreground mb-3">What ZX-Chat AI offers</p>
        ...
        <div className="bg-white rounded-2xl border border-border shadow-sm p-5 fade-up">
          ...
          <div className="space-y-2 text-sm">
            <Row label="Developer" value="ZX-Chat AI Team" />
            <Row label="Contact" value="support@zxchatai.com" />
            <Row label="Privacy" value="privacy@zxchatai.com" />
          </div>
          <p className="text-xs text-muted-foreground mt-3">
            (Update contact emails before Play Store submission.)
          </p>
        </div>

        <p className="text-center text-xs text-muted-foreground pb-2">
          © 2025 ZX-Chat AI · All rights reserved
        </p>
      </div>
    </div>
  );
